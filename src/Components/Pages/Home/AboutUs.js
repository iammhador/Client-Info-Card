  ...
  return (
    <div className="bg-black px-8 md:px-12 lg:px-20 py-10 md:14 lg:py-20">
      <h2
        ...
        className="text-white text-xl md:text-2xl lg:text-5xl font-bold text-center uppercase mb-7"
      >
        About us
      </h2>
      <p
        data-aos="zoom-in"
        data-aos-duration="2000"
        className="text-sm md:text-base lg:text-lg text-gray-300 font-normal text-justify"
      >
