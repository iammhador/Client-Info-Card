      ...
      <div className="grid grid-cols-1 md:grid-cols-2 flex-col-reverse bg-black px-8 md:px-12 lg:px-20 pt-20 md:pt-0 lg:py-20">
        <div className="my-auto">
          ...
          <div className="pr-0 md:pr-7 lg:pr-64">
            <p className="text-xs md:text-xs lg:text-base font-medium text-gray-300 py-3 md:py-4 lg:py-7 text-justify md:text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 flex-col-reverse bg-black px-8 md:px-12 lg:px-20 py-10 md:14 lg:py-20">
        ...
        <div className="my-auto text-right">
          ...
          <div className="pl-0  md:pl-7 lg:pl-64">
            <p className="text-xs md:text-xs lg:text-base font-medium text-gray-300 py-3 md:py-4 lg:py-7 text-justify md:text-right">
